...
var FormComponent = /** @class */ (function () {
    function FormComponent(fb, router, appService) {
        this.fb = fb;
        this.router = router;
    ...
    FormComponent.prototype.onSubmit = function () {
        ...
        // console.log(form);
        this.appService.post(form).subscribe(function (data) {
            // console.log(data);
        });
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.post = function (body) {
        return this.http.post("/api/hamrah", body);
    };
    AppService.prototype.delete = function () {
...
var TableDataSource = /** @class */ (function (_super) {
    ...
    function TableDataSource(appService, displayedColumns) {
        var _this = _super.call(this) || this;
        _this.appService = appService;
        _this.displayedColumns = displayedColumns;
        _this.unfilteredData = [];
        _this.dataSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]([]);
        return _this;
    }
    TableDataSource.prototype.filterData = function (filterText) {
        this.data =
            filterText.trim() === ""
                ? this.unfilteredData
                : this.displayedColumns.reduce(function (acc, item) {
                    var passed = [];
                    var failed = [];
                    acc.failed.forEach(function (element, index) {
                        return JSON.stringify(element[item])
                            .toLowerCase()
                            .indexOf(filterText) > -1
                            ? passed.push(index)
                            : failed.push(index);
                    });
                    passed = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](new Set(passed)).map(function (idx) { return acc.failed[idx]; });
                    failed = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](new Set(failed)).map(function (idx) { return acc.failed[idx]; });
    ...
    TableDataSource.prototype.connect = function () {
        ...
        this.appService.get().subscribe(function (data) {
            console.log(data);
            _this.data = data;
        });
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"].apply(void 0, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](dataMutations1)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () {
            return _this.getPagedData(_this.getSortedData(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.data)));
        }));
    };
    /**
    ...
    TableDataSource.prototype.loadData = function () {
        // this.loadingSubject.next(true);
        var _this = this;
        this.appService.get().subscribe(function (data) {
            console.log(data);
            _this.data = data;
            _this.unfilteredData = data;
    ...
    TableDataSource.prototype.getSortedData = function (data) {
        ...
        return data.sort(function (a, b) {
            ...
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_this.displayedColumns), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var displayedColumns = _c.value;
                    if (_this.sort.active === displayedColumns) {
    ...
    TableDataSource.ctorParameters = function () { return [
...
var TableComponent = /** @class */ (function () {
    function TableComponent(appService) {
        this.appService = appService;
        /** Columns displayed in the table. Columns IDs can be added, removed, or reordered. */
        this.displayedColumns = ["firstName", "lastName", "mobile", "email", "country", "city"];
    }
    TableComponent.prototype.exportToExcel = function () {
        var workSheet = xlsx__WEBPACK_IMPORTED_MODULE_7__["utils"].json_to_sheet(this.dataSource.data, {
    ...
    TableComponent.prototype.deleteAll = function () {
        if (confirm("Are you sure you want to delete all the requests?")) {
            this.appService.delete().subscribe(function (data) {
